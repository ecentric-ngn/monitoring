...
@Component({
  selector: "app-cancelled-specialized-trade",
  templateUrl: "./cancelled-specialized-trade.component.html",
  styleUrls: ["./cancelled-specialized-trade.component.scss"],
})
export class CancelledSpecializedTradeComponent {
  searchQuery: any;
  errorMessage: any;
...
shouldShowActionButton(): boolean {
  ...
  navigate(data: any) {
   const title = 'List Of Cancelled Specialized Trade'
  ...
  getid(specializedTradeNo: any) {
    this.specializedTradeNo = specializedTradeNo;
  }
  saveSpecializedTrade(actionForm) {
    ...
    this.reregisterCancelledSpecializedTrade();
  }
...
uploadFileForSpecializedTrade() {
  ...
  //save deregister
  reregisterCancelledSpecializedTrade() {
    ...
    const CancelledSpecializedTrade = {
      reregisterDate: this.formData.Date,
      reregisteredDetails: this.formData.Details,
      reregisterBy: this.uuid,
      specializedTradeNo: this.specializedTradeNo,
      fileId:this.fileId
    };
    this.service.saveCancelledReregister(CancelledSpecializedTrade).subscribe(
      (response: any) => {
        setTimeout(() => {
  ...
  showReregisterMessage() {
    this.messageService.add({ severity: 'success', summary: 'Success', detail: 'Specialized Trade Reregister successfully' });
  }
