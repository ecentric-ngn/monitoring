...
@Component({
  selector: 'app-suspend-specialized-firm',
  templateUrl: './suspend-specialized-firm.component.html',
  styleUrls: ['./suspend-specialized-firm.component.scss']
})
export class SuspendSpecializedFirmComponent {
  ...
  selectedFile:File;
  fileId: any;
  constructor(private router: Router, private service:SpecializedFirmService, 
...
shouldShowActionButton(): boolean {
  ...
  navigate(data: any) {
    const title = 'List Of Suspended Specialized Firm '
...
SaveSpecializedFirm(actionForm) {
  ...
  this.ReinstateSuspendedSpecializedFirm();
}
