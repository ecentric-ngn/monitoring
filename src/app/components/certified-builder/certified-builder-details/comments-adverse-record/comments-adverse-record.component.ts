...
export class CommentsAdverseRecordComponent {
    ...
    getRecordList(data: any) {
      const certifiedBuilder = {
        viewName: 'certifiedBuilderAdverseCommentRecord',
        pageSize: this.pageSize,
        pageNo: this.pageNo,
        condition: [{ field: 'certifiedBuilderNo', value: data.certifiedBuilderNo }],
      };
      this.loading=true
    ...
    saveComment(){
      ...
      const commentRecord = {
        ...
        certifiedBuilderNo: this.data.certifiedBuilderNo,
      };
