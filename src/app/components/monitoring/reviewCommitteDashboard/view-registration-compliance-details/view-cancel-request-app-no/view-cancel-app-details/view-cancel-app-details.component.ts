...
@Component({
  selector: 'app-view-cancel-app-details',
  templateUrl: './view-cancel-app-details.component.html',
  styleUrls: ['./view-cancel-app-details.component.scss']
})
export class ViewCancelAppDetailsComponent {
bctaNo: string = '';
