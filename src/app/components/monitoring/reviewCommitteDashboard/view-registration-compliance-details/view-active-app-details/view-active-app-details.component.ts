...
@Component({
  selector: 'app-view-active-app-details',
  templateUrl: './view-active-app-details.component.html',
  styleUrls: ['./view-active-app-details.component.scss']
})
export class ViewActiveAppDetailsComponent {
bctaNo: string = '';
...
getAppDetailsByBcNo() {
  ...
  const payload = [
    {
      field: 'bctaNo',
      value: this.WorkDetail.contractorNo,
      condition: 'LIKE',
      operator: 'AND'
    }
  ];
